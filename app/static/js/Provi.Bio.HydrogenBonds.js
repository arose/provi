...
Provi.Bio.HydrogenBonds.HbondParamsWidget.prototype = Utils.extend(Provi.Widget.ParamsWidget, {
    params_dict: {
        bond_mode_or: { 'default': false, type: "bool" },
        filter: { 'default': "sidechain", type: "str", options: [ 'all', 'backbone', 'sidechain' ] },
        angle_min: { 'default': 60, type: "float", range: [ 20, 120 ] },
        dist_max: { 'default': 3.9, type: "float", range: [ 2, 5 ] }
    }
});
